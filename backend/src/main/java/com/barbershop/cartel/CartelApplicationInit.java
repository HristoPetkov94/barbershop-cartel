...
@Component
public class CartelApplicationInit {
    ...
    @Bean
    public CommandLineRunner init(JwtUserDetailsService userService,
    ...
    private BarberEntity createBarber1() {
    ...
    private BarberEntity createBarber2() {
    ...
    private ServiceEntity createService1() {
    ...
    private ServiceEntity createService2() {
    ...
    private ServiceEntity createService3() {
    ...
    private ServiceEntity createService4() {
    ...
    private AssignmentEntity assignment1(BarberEntity barber, ServiceEntity service) {
    ...
    private AssignmentEntity assignment2(BarberEntity barber, ServiceEntity service) {
    ...
    private AssignmentEntity assignment3(BarberEntity barber, ServiceEntity service) {
    ...
    private AssignmentEntity assignment4(BarberEntity barber, ServiceEntity service) {
    ...
    private AssignmentEntity assignment5(BarberEntity barber, ServiceEntity service) {
